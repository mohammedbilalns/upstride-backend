...
export const registerPresentationBindings = (container: Container): void => {
	...
	container.bind(UsersManagementController).to(UsersManagementController);
	container.bind(TYPES.Controllers.Users).to(UsersManagementController);
	container.bind(AdminManagementController).to(AdminManagementController);
	container.bind(TYPES.Controllers.Admins).to(AdminManagementController);

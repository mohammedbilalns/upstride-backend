...
import { articleCommentSchema, articleCommentUpdateSchema, deleteCommentSchema, fetchCommentsQuerySchema } from "../validations/comment.validation";
...
export class ArticleCommentController {
	...
	createComment = asyncHandler(async (req, res) => {
		...
		await this._articleCommentService.createComment({userId, userName,userImage, ...articleCommentDto});
	...
	updateComment = asyncHandler(async (req, res) => {
		...
		await this._articleCommentService.updateComment({userId, ...articleCommentUpdateDto});
	...
	fetch= asyncHandler(async (req, res) => {
		...
		const comments = await this._articleCommentService.getComments(fetchCommentsDto);

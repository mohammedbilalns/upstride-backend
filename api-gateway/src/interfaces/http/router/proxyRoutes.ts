...
import { SERVICE_URL, ServiceName } from "../../../infra/config/serviceRegistry";
...
router.use(
	"/auth",proxy(env.IDENTITY_SERVICE_URL, {
		...proxyOptions,
...
router.use(
	"/notifications",
	createServiceProxy(ServiceName.NOTIFICATION, SERVICE_URL[ServiceName.NOTIFICATION])
);

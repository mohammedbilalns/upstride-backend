...
import {
	SERVICE_URL,
	ServiceName,
} from "../../../infra/config/service-registry";
import { createServiceProxy } from "../../../utils/create-service-proxy";
import logger from "../../../utils/logger";
import { filterArticlesByCategory } from "../controllers/article-by-category.controller";
